...
/////////////////////////////////////////// 
char deviceId []    = "NB103811";                                   // Put here the device_ID generated by the NearHub ( NB1xxxxx )
char sharedSecret[] = "12389032";                             // The same as you configured in the NearHub (8 characters/number)  
char ssid[]         = "EdimaxADSL";                                 // your network SSID (name)
char pass[]         = "skoop@123";                        // your network password (use for WPA, or use as key for WEP)
int  keyIndex       = 0;                                         // your network key Index number(only for WEP)
byte wifiMode       = 1;                                         // Encription Mode: Open = 0 | WAP2 = 1 | WEP = 2 
...
//
//  http://nearbus.net/v1/api_vmcu_jsb/NB103811?user=Chevindu&pass=shadytillidie123&channel=0&service=DIG_OUTPUT&value=1&method=POST&reqid=123456
//
